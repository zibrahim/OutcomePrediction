...
def main():
    ...
    time_series= pd.read_csv(timeseries_path+"TimeSeriesAggregated.csv")
    ...
    for outcome in outcome_columns:
        ...
        flat_df.to_csv(timeseries_path+"NonSMOTEDTimeSeries/"+outcome+"FlatTimeSeries2Days.csv", index=False)
        ...
        smoted_df.to_csv(timeseries_path+"SMOTEDTimeSeries/"+outcome+"FlatTimeSeries2Days.csv", index=False)
        ...
        smoted_timeseries.to_csv(timeseries_path+"SMOTEDTimeSeries/"+outcome+"StackedTimeSeries2Days.csv", index=False)
